...
exports.buildPage = exports.route = void 0;
...
if (!fs_1.default.existsSync(staging)) {
    fs_1.default.mkdirSync(staging);
}
...
exports.route.post("/web", (0, express_validator_1.body)("id").exists(), Middlewares_1.validatorsMiddleware, Middlewares_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, accessLogs_1.successLogger)(`web: ${web.name} is build success!`, req);
        res.send({
...
exports.route.post("/page", (0, express_validator_1.body)("id").exists(), Middlewares_1.validatorsMiddleware, Middlewares_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        socketIO_1.IOEmit.emitEvent("cms-page", "updated", id, {
            perIndex: 0,
        });
        res.send({
            page,
...
function buildPage(page, env = "staging") {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield (0, promises_1.cp)(path_1.default.join(process.cwd(), "/fonts"), path_1.default.join(webFolder, "/fonts"), {
                recursive: true,
            });
  ...
  \t${generateOGP(page.title, new URL(page.url, page.web.ogURL).href, new URL("/imgs/" + page.web.ogImage, page.web.ogURL).href, page.description || page.web.ogDescription)}
  <style>
  \t${page.theme.style}
  \t${page.style}
  \t${page.formStyle}
  ...
  <script>
    ...
    \t${page.formScript}
        ...
        const matchImg = html.match(/(?<=href="\/[A-z0-9\/.\-_%]+)[A-z0-9_]+.(jpg|png|ico)|(?<=src="\/[A-z0-9\/.\-_%]+)[A-z0-9_]+.(jpg|png|gif|webp|svg)|(?<=content="[A-z0-9\/.\-_%:]+)[A-z0-9_]+.(jpg|png|webp|svg)/gim);
        if (matchImg) {
        ...
        const matchDoc = html.match(/(?<=href="\/[A-z0-9\/.\-_%]+)[A-z0-9_]+.(csv|doc|docx|xls(x)?|pdf)/gim);
        if (matchDoc) {
